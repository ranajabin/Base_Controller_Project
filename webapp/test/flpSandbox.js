		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#table1tablelistcontrollerproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"table1tablelistcontrollerproject-display": {
								"semanticObject": "table1tablelistcontrollerproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=table1.tablelistcontrollerproject",
									"url": sap.ui.require.toUrl("table1/tablelistcontrollerproject")
								}
							}
						}
					}
